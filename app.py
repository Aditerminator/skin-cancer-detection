...
# Load models
yolo_model = YOLO('./models/yolov8n_cls.pt')  # YOLOv8 model
resnet_model = load_model('./models/resnet_model.h5')  # ResNet model
...
def upload():
    ...
    yolo_class = yolo_results[0].names[yolo_results[0].probs.top1]
    ...
    image_url = os.path.join('static','uploads', image_filename)  # Path relative to static folder
